...
bdclean$PLUR_new[bdclean$PLUR == 1] = "first child"
...
#Potentially Determine Interaction Variables
...
Simple_Model_1 <- lm(BWTG_C ~ male, CORES, CIGPN_bucket, CIGFN_bucket, CIGSN_bucket, CIGLN_bucket, GEST_C, PLUR_new, MAGE, MRACER, PARITY_new) 
  
#Simple Model with Smoking as a Binary Variable                  
Simple_Model_2 <- lm(BWTG_C ~ male, CORES, CIGPN_dichotic, CIGFN_dichotic, CIGSN_dichotic, CIGLN_dichotic, GEST_C, PLUR_new, MAGE, MRACER, PARITY_new)
```
