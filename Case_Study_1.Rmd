...
Simple_Model_1 <- lm(BWTG_C ~ male + as.factor(CORES) + CIGPN_bucket + CIGFN_bucket + CIGSN_bucket + CIGLN_bucket + GEST_C + PLUR_new + MAGE_center + MRACER + PARITY_new, data = bdclean) 
  
#Simple Model with Smoking as a Binary Variable                  
Simple_Model_2 <- lm(BWTG_C ~ male + as.factor(CORES) + CIGPN_dichotic + CIGFN_dichotic + CIGSN_dichotic + CIGLN_dichotic + GEST_C + PLUR_new + MAGE_center + MRACER + PARITY_new, data = bdclean)
```
...
Simple_Model_3 <- lm(BWTG_C ~ male + as.factor(CORES) + CIGPN_dichotic + CIGFN_dichotic + CIGSN_dichotic + CIGLN_dichotic + GEST_C + GEST_C_sq + PLUR_new + MAGE_center + MRACER + PARITY_new, data = bdclean)
