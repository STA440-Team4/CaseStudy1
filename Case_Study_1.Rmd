...
By the end of our exploratory data analysis, we determined that we wanted to work with all of the variables except for year of birth, and we had transformed a few of the numerical variables to categorical variables. Our first simple linear model yielded a model with an R^2 around .4993 with and R^2 adjusted of .4992. Here, we kept the cigarettes smoked in separate buckets. We also tried a simple model with cigarettes smoked as a binary variable, which yielded a similar R^2. 
